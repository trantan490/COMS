<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="listTakeOut.aspx.cs" Inherits="main_visit_listVisit" Title="신청 내역" %>
...
<tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td class="contents_title">반출 신청 내역</td>
			<td align="right" class="location">HOME &gt; 반출 신청 내역</td>
		</tr>
		<tr>
