<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="viewVisitManager.aspx.cs" Inherits="main_visit_viewVisit" Title="상세 보기" %>
...
function approveSelect(){
	...
	var visit=<%=visit%>;
	if(visit==1){
	alert('[알림]장기내방신청의 경우 총무그룹(이규형 차장)의 합의를 득해야 합니다.');
	}
	
    // 2019-07-12-임종우 : 장기내방 양식변경으로 URL 수정
