<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="listSecCard.aspx.cs" Inherits="main_secCard_listSecCard" Title="신청 내역" %>
...
<tr>
	<td>
		...
		<tr>
			...
			<td><span class="contents_title">출입권한 신청 내역</span> (임시저장된 문서는 결재를 진행하여야 출입권한 신청 처리가 가능합니다.)</td>
			<td align="right" class="location">HOME &gt; 출입권한 신청 내역</td>
		</tr>
		<tr>
	...
	<td valign="top">			
			...
			<td align="right">
				...
				<img src="../../images/icon/calendar.gif" alt="날짜선택" style="cursor:hand" align="absmiddle"  onclick="popUpCalendar(this, <%=txtEndDate.ClientID%>,'yyyy-mm-dd',-1,-1);" />
					<asp:DropDownList id="txtKeyWord" runat="server">
                        <asp:ListItem Value="requestUserName">신청자</asp:ListItem>
		...
		<tr>
			...
			<HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
						<Columns>
                            <asp:BoundField DataField="RegDate" HeaderText="신청일" SortExpression="RegDate" >
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Flag" HeaderText="신규구분" SortExpression="Flag">
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                            <asp:BoundField DataField="RequestDepDesc" HeaderText="신청부서" SortExpression="RequestDepDesc" >
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                            <asp:BoundField DataField="RequestUserName" HeaderText="신청자" SortExpression="RequestUserName" >
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                            <asp:BoundField DataField="RoleDesc" HeaderText="직급" SortExpression="RoleDesc" >
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                            <asp:BoundField DataField="OfficePhone" HeaderText="내선번호" SortExpression="OfficePhone" >
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
