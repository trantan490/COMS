<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="visitorRejectList.aspx.cs" Inherits="_Default" Title="내방 반출입 관리자" %>
        ...
        <tr>
            <td align="left" valign="top" style="height: 24px">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
					...
					OnRowDataBound="GridView1_RowDataBound" Width="100%" AllowPaging="True" PageSize="50" EmptyDataText="등록 된 내용이 없습니다.">
