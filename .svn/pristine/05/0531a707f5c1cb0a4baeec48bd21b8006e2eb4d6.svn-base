    ...
    <div>
		...
		<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
			...
			<Columns>
                ...
                <asp:BoundField DataField="OfficePhoneNumber" HeaderText="내선번호" SortExpression="OfficePhoneNumber" >
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="MobilePhoneNumber" HeaderText="휴대폰번호" SortExpression="MobilePhoneNumber" >
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
			</Columns>
