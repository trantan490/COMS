<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="carCategoryEdit.aspx.cs" Inherits="_Default" Title="차량 관리자" %>
        ...
        <tr>
            ...
            <td style="background-color: #f5f5f5; height: 26px;">
                <asp:TextBox ID="codeName" runat="server" ValidationGroup="AllValidators"></asp:TextBox><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator1" runat="server" ControlToValidate="codeName" ErrorMessage="차종을 입력하여 주십시요" ValidationGroup="AllValidators" Display="Dynamic">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td style="width: 100px; background-color: #dcdcdc; height: 30px;" align="center">
				사용유무</td>
