<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="visitObjectList.aspx.cs" Inherits="_Default" Title="내방 반출입 관리자" %>
        ...
        <tr>
            <td align="left" valign="top" style="height: 24px">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
					...
					<Columns>
						<asp:BoundField DataField="VisitObjectName" HeaderText="방문 목적" SortExpression="VisitObjectName">
