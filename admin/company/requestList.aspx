<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="requestList.aspx.cs" Inherits="_Default" Title="업체 관리" %>
            ...
            <td align="left" valign="top" style="height: 24px">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
					...
					<Columns>
						...
						<asp:BoundField DataField="EmployeeName" HeaderText="신청자" SortExpression="EmployeeName">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" />
						</asp:BoundField>
						<asp:HyperLinkField HeaderText="승인">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" />
						</asp:HyperLinkField>
					</Columns>
